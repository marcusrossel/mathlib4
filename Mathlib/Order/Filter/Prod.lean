...
theorem prod_assoc (f : Filter α) (g : Filter β) (h : Filter γ) :
  ...
  sorry -- simp_rw [← comap_equiv_symm, SProd.sprod, Filter.prod, comap_inf, comap_comap, inf_assoc, (· ∘ ·), Equiv.prodAssoc_symm_apply]
...
theorem prod_assoc_symm (f : Filter α) (g : Filter β) (h : Filter γ) :
  ...
  sorry -- simp_rw [map_equiv_symm, SProd.sprod, Filter.prod, comap_inf, comap_comap, inf_assoc, Function.comp, Equiv.prodAssoc_apply]
